...
####################################################
# imported functions from scipy (distributions.py) #
####################################################
...
#import gammaln as gamln
import optimize
#from basic import gammaln as gamln    #gamma need this one
...
################################################
# imported functions from scipy (optimize.py)  #
################################################
...
###################################################
# imported functions from scipy (linesearch.py)   #
###################################################
...
##############################################
# imported functions from scipy (doccer.py)  #
##############################################
...
rep_tmp = [1, 2, 3, 5, 7, 8, 12, 13, 24, 1, 1, 2, 3, 5, 7, 8, 9, 12, 13]
params = expon.fit(rep_tmp)
